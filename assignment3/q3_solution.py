{
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        "id": "OzKu6ttAuuG2",
        "outputId": "dac537d9-d42a-48ec-ab8e-7cfff4e14617",
        "colab": {
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "remote: Total 196 (delta 98), reused 71 (delta 24), pack-reused 0\u001b[K\n",
            "Receiving objects: 100% (196/196), 3.82 MiB | 17.15 MiB/s, done.\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "MLP_mode=None  #'no_pred_mlp' # 'fixed_random_init'\n",
        "\n",
        "# optimizer\n",
        "lr = 0.03\n",
        "momentum = 0.9\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "LOwipW2jtP-E",
        "outputId": "10053fa1-2853-4bb9-d367-4ce6b0b8e619"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "bAD9GhtotP-G",
        "outputId": "40fe28f2-5ea6-4404-8adc-bc6ac45ca47f"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        "id": "FMRggBg1Z5Nl",
        "outputId": "e26941fe-8e6b-4332-ac0e-e379757323a6",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Ct7Aw5letP-H",
        "outputId": "649fee82-e71e-4210-8fbb-0a16a44959de"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "tensor(-0.6297, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "Train Epoch: [67/102] Train Loss:-0.64707\n",
            "Test Epoch: [67/102] knn_Acc@1: 56.00%\n",
            ...
            "tensor(0.6323, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6332, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6326, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6331, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6361, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6354, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6495, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6494, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6494, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6279, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6277, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6278, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6356, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6396, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6734, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6718, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6726, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6321, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "Train Epoch: [68/102] Train Loss:-0.64703\n",
            "Test Epoch: [68/102] knn_Acc@1: 55.21%\n",
            "tensor(0.6385, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6379, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6284, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6460, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6457, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(-0.6569, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6503, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6494, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6390, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6622, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6612, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6617, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6489, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6493, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6491, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [69/102] Train Loss:-0.64653\n",
            "Test Epoch: [69/102] knn_Acc@1: 56.31%\n",
            "tensor(0.6605, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6594, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6600, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6596, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6585, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6630, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6375, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6677, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6560, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "Train Epoch: [70/102] Train Loss:-0.64765\n",
            "Test Epoch: [70/102] knn_Acc@1: 56.40%\n",
            ...
            "tensor(-0.6426, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6421, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6367, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "Train Epoch: [71/102] Train Loss:-0.64836\n",
            "Test Epoch: [71/102] knn_Acc@1: 56.62%\n",
            "tensor(0.6564, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6564, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6564, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(-0.6589, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6508, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6524, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6516, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6491, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6537, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6394, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6381, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6388, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6438, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6440, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6439, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6565, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6547, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6551, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [72/102] Train Loss:-0.65035\n",
            "Test Epoch: [72/102] knn_Acc@1: 57.14%\n",
            ...
            "tensor(0.6414, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6425, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6420, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6486, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6501, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6494, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6532, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6396, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6379, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6387, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6412, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6414, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6447, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6613, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6610, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6611, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6504, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6497, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6401, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [73/102] Train Loss:-0.64835\n",
            "Test Epoch: [73/102] knn_Acc@1: 56.85%\n",
            "tensor(0.6509, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6511, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "Train Epoch: [74/102] Train Loss:-0.65015\n",
            "Test Epoch: [74/102] knn_Acc@1: 57.38%\n",
            "tensor(0.6544, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6540, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6542, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6447, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6447, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [75/102] Train Loss:-0.65022\n",
            "Test Epoch: [75/102] knn_Acc@1: 57.72%\n",
            "tensor(0.6510, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6524, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6517, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6559, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6568, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6576, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6572, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6522, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6522, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6522, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6567, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6575, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6461, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6449, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6455, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6586, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6582, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6544, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6545, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6544, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6406, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6434, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6420, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6496, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6487, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6492, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6442, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6438, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6320, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6433, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6441, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [76/102] Train Loss:-0.64970\n",
            "Test Epoch: [76/102] knn_Acc@1: 57.19%\n",
            "tensor(0.6431, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6432, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6622, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6609, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6616, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6526, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6534, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6530, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6541, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6633, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6657, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6645, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6560, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6559, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6559, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6593, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6429, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6427, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [77/102] Train Loss:-0.65112\n",
            "Test Epoch: [77/102] knn_Acc@1: 57.78%\n",
            "tensor(0.6535, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6521, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6528, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6356, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6341, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6348, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6573, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6577, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6575, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6582, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6475, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6472, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6473, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6656, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6646, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6651, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6460, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6462, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6597, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6596, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [78/102] Train Loss:-0.65209\n",
            "Test Epoch: [78/102] knn_Acc@1: 57.16%\n",
            "tensor(0.6549, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6554, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6552, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6495, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6538, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6537, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6538, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6383, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6381, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6382, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6525, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6669, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6449, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6452, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6553, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6550, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [79/102] Train Loss:-0.65268\n",
            "Test Epoch: [79/102] knn_Acc@1: 57.68%\n",
            "tensor(0.6529, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6547, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6538, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6451, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6634, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6629, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6700, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6572, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6562, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6624, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6618, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6621, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6540, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6542, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [80/102] Train Loss:-0.65572\n",
            "Test Epoch: [80/102] knn_Acc@1: 57.89%\n",
            "tensor(0.6467, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6470, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6469, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6655, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6653, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6667, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6667, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6480, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6490, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6485, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6534, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6552, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6554, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [81/102] Train Loss:-0.65343\n",
            "Test Epoch: [81/102] knn_Acc@1: 58.14%\n",
            "tensor(0.6543, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6545, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6544, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6620, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6733, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "Train Epoch: [82/102] Train Loss:-0.65511\n",
            "Test Epoch: [82/102] knn_Acc@1: 58.23%\n",
            "tensor(0.6596, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6576, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6586, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6680, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6671, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6686, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6607, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6595, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6601, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6627, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6736, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6726, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6600, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6599, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6600, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6712, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6713, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6713, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [83/102] Train Loss:-0.65555\n",
            "Test Epoch: [83/102] knn_Acc@1: 58.01%\n",
            "tensor(0.6611, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6616, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6613, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6621, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6627, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6624, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6382, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6383, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6382, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6520, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6663, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6660, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6661, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6561, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6583, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6572, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6494, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6583, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6563, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6573, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [84/102] Train Loss:-0.65616\n",
            "Test Epoch: [84/102] knn_Acc@1: 58.52%\n",
            "tensor(0.6509, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6504, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6507, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6496, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6772, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6765, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6769, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6649, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6647, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6648, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6432, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6684, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6512, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6516, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6514, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6594, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6747, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6737, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6561, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6557, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [85/102] Train Loss:-0.65604\n",
            "Test Epoch: [85/102] knn_Acc@1: 58.40%\n",
            "tensor(0.6691, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6674, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6682, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6626, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6622, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [86/102] Train Loss:-0.65607\n",
            "Test Epoch: [86/102] knn_Acc@1: 58.40%\n",
            "tensor(0.6677, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6676, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6677, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6646, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6654, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6503, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6503, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6732, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6658, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6645, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6652, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6559, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6557, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6558, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6622, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6472, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6486, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [87/102] Train Loss:-0.65710\n",
            "Test Epoch: [87/102] knn_Acc@1: 58.51%\n",
            "tensor(0.6594, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6587, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6591, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6519, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6692, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6526, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6525, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6525, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6599, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6564, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6557, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [88/102] Train Loss:-0.65524\n",
            "Test Epoch: [88/102] knn_Acc@1: 58.54%\n",
            "tensor(0.6540, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6541, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6540, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6538, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6594, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6698, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6693, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6695, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6605, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6604, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6605, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6500, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6560, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6565, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [89/102] Train Loss:-0.65689\n",
            "Test Epoch: [89/102] knn_Acc@1: 58.87%\n",
            ...
            "tensor(0.6618, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6622, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6726, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6725, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6726, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6577, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6583, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6554, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6742, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6728, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6735, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6546, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6563, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6555, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6497, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6537, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6537, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6759, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6648, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6639, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [90/102] Train Loss:-0.65838\n",
            "Test Epoch: [90/102] knn_Acc@1: 58.81%\n",
            "tensor(0.6658, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6649, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6653, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6535, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6692, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6697, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6694, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6638, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6640, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6639, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6610, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6466, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6469, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6729, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6736, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6732, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6617, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6616, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [91/102] Train Loss:-0.65802\n",
            "Test Epoch: [91/102] knn_Acc@1: 58.79%\n",
            "tensor(0.6631, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6626, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6629, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6680, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6535, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6531, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [92/102] Train Loss:-0.65561\n",
            "Test Epoch: [92/102] knn_Acc@1: 59.00%\n",
            "tensor(0.6632, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6639, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6636, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6602, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6725, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6729, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6727, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6543, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6531, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6537, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6698, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6560, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6557, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6723, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6728, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6608, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6610, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [93/102] Train Loss:-0.65826\n",
            "Test Epoch: [93/102] knn_Acc@1: 58.54%\n",
            "tensor(0.6566, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6566, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6566, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6543, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6706, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6709, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6707, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6642, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6648, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [94/102] Train Loss:-0.65885\n",
            "Test Epoch: [94/102] knn_Acc@1: 58.81%\n",
            "tensor(0.6709, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6717, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6713, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6551, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6640, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6631, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [95/102] Train Loss:-0.65896\n",
            "Test Epoch: [95/102] knn_Acc@1: 58.75%\n",
            "tensor(0.6565, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6571, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6568, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6549, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6533, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6538, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6768, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6626, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6693, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6704, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6698, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6584, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6584, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6584, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6579, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6694, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [96/102] Train Loss:-0.65879\n",
            "Test Epoch: [96/102] knn_Acc@1: 58.87%\n",
            "tensor(0.6525, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6507, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6516, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6592, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6559, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6564, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [97/102] Train Loss:-0.65771\n",
            "Test Epoch: [97/102] knn_Acc@1: 58.95%\n",
            "tensor(0.6578, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6588, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6583, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6568, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6705, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6694, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6539, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6532, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6536, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6632, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6633, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6748, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6738, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6743, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6722, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6726, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6724, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6511, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6511, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6511, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [98/102] Train Loss:-0.65963\n",
            "Test Epoch: [98/102] knn_Acc@1: 58.83%\n",
            "tensor(0.6550, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6559, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6554, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6670, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6714, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6715, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6488, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6494, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6491, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6558, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6678, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6687, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6683, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6650, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6653, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6651, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6636, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6640, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6628, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [99/102] Train Loss:-0.65983\n",
            "Test Epoch: [99/102] knn_Acc@1: 58.78%\n",
            "tensor(0.6553, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6556, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6554, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6567, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6753, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6598, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6598, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6796, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6814, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6561, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6766, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6767, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6767, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6578, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6594, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6586, device='cuda:0', grad_fn=<MulBackward0>)\n",
            ...
            "tensor(0.6675, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6673, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [100/102] Train Loss:-0.66100\n",
            "Test Epoch: [100/102] knn_Acc@1: 58.87%\n",
            "tensor(0.6501, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6491, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6496, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6581, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(-0.6744, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6807, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6817, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6812, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6664, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(0.6670, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6667, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "tensor(0.6597, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            ...
            "tensor(0.6505, device='cuda:0', grad_fn=<MeanBackward0>)\n",
            "tensor(-0.6511, device='cuda:0', grad_fn=<MulBackward0>)\n",
            "Train Epoch: [101/102] Train Loss:-0.66030\n",
            "Test Epoch: [101/102] knn_Acc@1: 58.90%\n"
          ]
        }
      ],
      "source": [
        ...
        "        }, is_best=False, filename=save_path + '/wo_sg_checkpoint_{:04d}.pth.tar'.format(epoch))\n"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        "id": "778XIisYHIVx",
        "outputId": "6c3e5551-f3e2-45fe-b10a-56441e90cef0",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "zTw26rdUWMjH",
        "outputId": "67c52786-96df-4c4d-aae6-2cb57db20fe1",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "[-0.18416393891675398, -0.4432033219685157, -0.5096502508968115, -0.5304354292651018, -0.5370947420597076, -0.5308777118722597, -0.5449601958195368, -0.5665874294936657, -0.57571334267656, -0.5864114748934904, -0.5889788108567396, -0.5973737984895706, -0.598211241265138, -0.59311997021238, -0.5999094086388747, -0.6117722454170386, -0.6181723115344843, -0.6200581838687261, -0.6218327855070432, -0.6256362646818161, -0.6238561421632767, -0.628328966597716, -0.6335420310497284, -0.6367766199012598, -0.6385174927612146, -0.6388809159398079, -0.6440230707327524, -0.6469346582889557, -0.643216056128343, -0.6477906753619512, -0.6479705683887005, -0.6500458170970281, -0.6463467217981815, -0.6416825850804647, -0.6344660843412081, -0.6386087089776993, -0.6344648972153664, -0.641346275806427, -0.6410926183064779, -0.6394390327235063, -0.6380460845927397, -0.6413851367930571, -0.6352428644895554, -0.6392773327728113, -0.6454788620273272, -0.6519860848784447, -0.6482297691206137, -0.6549003074566523, -0.6664556674659252, -0.6477449983358383, -0.6500392605861028, -0.666359561185042, -0.6470397959152857, -0.6558850780129433, -0.6489622841278712, -0.6516695208847523, -0.652712307870388, -0.6540824261804422, -0.6519681923091412, -0.6495545580983162, -0.6499982687334219, -0.651484997322162, -0.6507029496133327, -0.649693333854278, -0.6472211442887783, -0.646447665989399, -0.647800282885631, -0.647068747629722, -0.6470266915857792, -0.64652648071448, -0.6476474876205126, -0.6483592291673025, -0.6503548175096512, -0.6483532153069973, -0.65014906351765, -0.6502229459583759, -0.6497045643627644, -0.6511182462175688, -0.6520882112284502, -0.6526839671035608, -0.6557216147581736, -0.653433850655953, -0.6551138833165169, -0.6555539841453234, -0.6561587837835153, -0.6560352283219496, -0.6560684156914552, -0.6571047566831112, -0.6552357201774915, -0.6568861144284407, -0.658377772818009, -0.6580165314177672, -0.6556076817214489, -0.6582599294682344, -0.6588496342301369, -0.6589576837917169, -0.6587860397994518, -0.6577108986675739, -0.6596255277593931, -0.6598323807120323, -0.6610011458396912, -0.6603019783894221]\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        "id": "E8IdOOkzWMeW",
        "outputId": "7b9eeb87-c5b9-4e0c-fd33-0a9f73dc95b2",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "[22.34, 23.04, 23.3, 25.569999999999997, 27.41, 30.380000000000003, 31.45, 32.08, 31.69, 32.59, 32.97, 34.04, 34.69, 35.28, 35.86, 35.620000000000005, 36.35, 36.53, 37.41, 37.76, 38.73, 39.73, 40.489999999999995, 41.199999999999996, 42.02, 42.13, 43.35, 44.1, 44.41, 44.89, 45.879999999999995, 45.81, 46.51, 46.9, 47.36, 47.29, 47.32, 47.349999999999994, 47.92, 48.42, 48.97, 48.3, 48.83, 49.3, 49.919999999999995, 48.97, 49.14, 49.15, 51.160000000000004, 50.760000000000005, 50.529999999999994, 51.4, 51.849999999999994, 51.21, 52.669999999999995, 52.62, 52.99, 53.26, 53.43, 53.55, 54.230000000000004, 54.39000000000001, 54.6, 54.879999999999995, 55.53, 55.75, 55.75, 56.00000000000001, 55.21, 56.31, 56.39999999999999, 56.620000000000005, 57.14, 56.85, 57.379999999999995, 57.720000000000006, 57.19, 57.78, 57.16, 57.68, 57.89, 58.14, 58.230000000000004, 58.01, 58.52, 58.4, 58.4, 58.51, 58.540000000000006, 58.87, 58.809999999999995, 58.79, 59.0, 58.540000000000006, 58.809999999999995, 58.75, 58.87, 58.95, 58.830000000000005, 58.78, 58.87, 58.9]\n"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "metadata": {
        "id": "WXkS5KrxtP-H",
        "outputId": "8d801012-5ab8-4a56-89c8-3a7963fc0859",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "iSUHu43IQ52r",
        "outputId": "871ca708-0c08-4aa3-c409-8292888ee2fe",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "Lymz8YM2tP-I",
        "outputId": "4ed55320-4d1f-45f3-f210-c3149fe974de",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "E-Hu_WQhtP-I",
        "outputId": "734a49e8-a694-429a-b338-6f28f133506b",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "Ha1_aD2JZ0AL",
        "outputId": "f2531c2e-e70d-4c7a-f112-97be05ee3513",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "| N/A   48C    P0    28W /  70W |   3520MiB / 15109MiB |      0%      Default |\n",
            "|                               |                      |                  N/A |\n",
            "+-------------------------------+----------------------+----------------------+\n",
            "                                                                               \n",
            "+-----------------------------------------------------------------------------+\n",
